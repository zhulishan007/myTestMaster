        ...
        handleSubmenuAccordion: function(e, el) {
            ...
            if ( li && submenu ) {
                ...
                if ( KTUtil.hasClass(li, 'kt-menu__item--open') === false ) {
                    ...
                    if ($(li).hasClass("lsTestSuite")) {
                        $(li).children(".kt-menu__link").children(".kt-menu__link-icon").html(" <i class='fa fa-folder-open'></i>");
                    }
                    if ($(li).hasClass("lsstoryboard")) {
                        $(li).children(".kt-menu__link").children(".kt-menu__link-icon").html(" <i class='flaticon2-file-2'></i>");
                    }
                    if ($(li).hasClass("lsstoryboardAll")) {
                        $(li).children(".kt-menu__link").children(".kt-menu__link-icon").html(" <i class='fa fa-folder-open'></i>");
                    }
                    if ($(li).hasClass("lsTestCase")) {
                        $(li).children(".kt-menu__link").children(".kt-menu__link-icon").html(" <i class='fa fa-folder-minus'></i>");
                    }
                    if ($(li).hasClass("lsdataset")) {
                        
                        $(li).children(".kt-menu__link").children(".kt-menu__link-icon").html(" <i class='fa fa-folder-minus'></i>");
                    }
                    if ($(li).hasClass("lsdatasetdrag")) {
                    ...
                    if ($(li).hasClass("lsstoryboardAll")) {
                        $(li).children(".kt-menu__link").children(".kt-menu__link-icon").html(" <i class='fa fa-folder'></i>");
                    }
                    if ($(li).hasClass("lsTestSuite")) {
                        $(li).children(".kt-menu__link").children(".kt-menu__link-icon").html(" <i class='fa fa-folder'></i>");
                    }
                    if ($(li).hasClass("lsTestCase")) {
                        $(li).children(".kt-menu__link").children(".kt-menu__link-icon").html(" <i class='fa fa-folder-plus'></i>");
                    }
                    if ($(li).hasClass("lsdataset")) {
                        $(li).children(".kt-menu__link").children(".kt-menu__link-icon").html(" <i class='fa fa-folder-plus'></i>");
                    }
