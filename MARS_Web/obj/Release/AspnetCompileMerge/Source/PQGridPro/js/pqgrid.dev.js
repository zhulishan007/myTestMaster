...
function(t) {
    ...
    o._createWidget = function(e, n) {
        ...
        t(document).triggerHandler("pqGrid:bootup", {
            ...
            on: !1,
            collapsed: !1
        }), n.flexHeight && (n.height = "flex"), n.flexWidth && (n.width = "flex"), e.iRefresh = new i.cRefresh(e), e.iKeyNav = new i.cKeyNav(e), e.iValid = new i.cValid(e), e.tables = [], e.$tbl = null, e.iCols = new i.cColModel(e), e.iSort = new i.cSort(e), e._initTypeColumns(), r.on("scroll" + o, function() {
    ...
    a.refreshCM = function(t, e) {
        ...
        if (a.evtBelongs(e)) {
            ...
            do {
                ...
                if (i.is("img") ? (o.type = "img", n = 1) : i.is(".pq-grid-cell,.pq-grid-number-cell") ? (o = a.getCellIndices({
                        $td: i
                    }), o.rowData && (o.type = o.column ? "cell" : "num", o.$td = i, n = 1, s("cellRightClick"))) : i.is(".pq-tab-item") ? (o.id = a.iTab.getId(i), o.type = "tab", n = 1) : i.is(".pq-grid-col") && (o = a.getHeadIndices(r), o.type = "head", o.$th = i, n = 1, s("headRightClick")), n) {
                    s("context");
                    break
                }
        ...
        var e, n = this.options,
            r = n.editModel;
        this.$div_focus || (r.inline ? (e = this.getCell(r.indices), e.css("padding", 0).empty()) : e = this.$cont, this.$div_focus = t(["<div class='pq-editor-outer'>", "<div class='pq-editor-inner'>", "</div>", "</div>"].join("")).appendTo(e))
        ...
        if (x = "function" == C || "string" == C ? y.callFn(x, w) : x, void 0 === x && "function" == typeof c.geditor && (x = c.geditor.call(y, w)), x !== !1) {
            ...
            S && (w.$editor = M.children(".pq-editor-focus"), this.callFn(S, w)), D = M.children(".pq-editor-focus");
            var X = u.filterKeys,
    ...
    e.cColModel = function(t) {
        ...
        init: function(t) {
            var e, n, r = this,
                ...
                a = o.columnTemplate,
                l = o.colModel;
            l || (r.autoGenColumns(), l = o.colModel), e = r.nestedCols(l), i.depth = e.depth, n = i.colModel = e.colModel, a && r.extend(n, a), r.getHeaderCells(), r.assignRowSpan(), r.cacheIndices(), i._trigger("CMInit", null, t)
        },
                ...
                for (v = 0; S > v; v++) {
                    ...
                    for (E = k, U = 0; E > U; U++) {
                        ...
                        var G = U + w,
                            ...
                            X = j[z],
                            Q = K.dataIndx;
                        K.copy !== !1 ? (z++, N[Q] = X, L && (L[Q] = u(V, K))) : (W++, "extend" == T && g > E + w && E++)
                    }
...
function(t) {
    ...
    i.prototype = {
        ...
        removeFeedback: function() {
            var t = this;
            t.$feedback && (t.$feedback.remove(),
                t.$feedback = null), t.that.$cont.css("cursor", ""), requestAnimationFrame(function() {
                t.setParent()
            })
        }
    }
...
function(t) {
    ...
    n.prototype = {
        ...
        getItemHtml: function(t, e) {
            if ("separator" == t) return "<tr class='pq-cmenu-item'><td colspan=4 class='pq-bg-3' style='height:0px;'></td></td>";
            var n = t.style,
                r = t.tooltip,
                i = n ? 'style="' + n + '"' : "",
                o = r ? 'title="' + r + '"' : "";
...
function(t) {
    ...
    n.prototype = {
        ...
        importS: function(t, n, r, i, o) {
            ...
            }), a.htFix && (s.pq_htfix = s.pq_ht = a.htFix), a.hidden && (s.pq_hidden = !0), I[l] = s;
        ...
        importWb: function(t) {
            var e, n, r = t.workbook,
                ...
                l = t.sheet,
                s = function(n) {
                    var r = o.importS(n, t.extraRows, t.extraCols, t.keepCM, t.headerRowIndx);
                    return r.sheet = n, r.hidden = n.hidden, e && e.push(r), r
                },
                d = function(t) {
                    a.options.dataModel.data = t.dataModel.data, delete t.dataModel, a.option(t)
                };
            e ? (Tab.clear(), r.sheets.forEach(function(t, e) {
                var n = s(t);
                e == i && d(n)
            }), Tab.model.activeId = i, a.element.show()) : (l = l || 0, n = r.sheets.filter(function(t, e) {
    ...
    r.prototype = t.extend({
        ...
        Export: function(t) {
            ...
            return l._trigger("beforeExport", null, t) === !1 ? !1 : "xlsx" == t.format ? (d ? (d.forEach(function(e, a) {
                (i = e.instance || !(n = e.sheet) && (i = l.iTab.create(a))) && (o = new r(i), n = o._Export(t).sheets[0], e.hidden && (n.hidden = !0)), c.sheets.push(n)
            }), c.activeId = s.activeId) : c = a._Export(t), l._trigger("workbookReady", null, {
                workbook: c
            }) === !1 ? c : t.workbook ? c : (t.workbook = c, e = pq.excel.exportWb(t), e = e || a.postRequest(t), l._trigger("exportData", null, t), e)) : a._Export(t)
        },
        _Export: function(t) {
            var e, n = this,
                r = n.that,
        ...
        getXlsBody: function(n, r, i, o, a, l, s, d, c, u, h) {
            ...
            for (p = 0; o > p; p++) {
                ...
                S = {}, q.length && (S.cells = q), D.pq_hidden && (S.hidden = !0), D.pq_htfix && (S.htFix = D.pq_htfix), j.copyStyle(S, D.pq_rowstyle, D.pq_rowprop), h && (H = (h.call(B, y) || {}).style, H && j.copyStyle(S, H)), pq.isEmpty(S) || (z.length !== p && (S.indx = p), z.push(S))
            }
            return z
        },
    ...
    t(document).on("pqGrid:bootup", function(t, n) {
        ...
        fixWidth: function(e) {
            ...
            var p = e.$editor,
                ...
                I = w.top,
                _ = b + a,
                q = t.extend({}, x.editModel, e.column.editModel),
                D = r.$cont,
                R = D.offset(),
                M = R.left,
                T = R.top,
            ...
            if ($[C] = P, m.css($), v) {
                ...
                L.fontSize = i.css("font-size"), L.fontFamily = i.css("font-family"), L.backgroundColor = j, L.color = i.css("color"), L.padding = parseInt(N.css("padding-top")) + 2 + "px " + (parseInt(N.css("padding-right")) + 2) + "px"
            } else L.width = a + 1;
            p.css(L), v && p.pqtext(q.saveKey != t.ui.keyCode.ENTER)
        }
    }
}(jQuery),
function(t) {
        ...
        createDrag: function(e, n) {
            ...
            e.hasClass("ui-draggable") || e.on("dblclick", function() {
                ...
                stop: function(t) {
                    ...
                    var e = t.pageY - r,
                        n = s.rowhtArr;
                    i.$top.remove(), a.pq_ht = a.pq_htfix = Math.max(n[l] + e, 10), o.refresh()
                }
            })
        }
    }
...
function(t) {
    pq.cRender = function() {
        ...
        _each: function(t, e, n, r, i, o) {
            for (var a, l = this, s = l.jump, d = 0; n >= d; d++) d = s(e, o, d),
                a = r[d], a[i] || t.call(l, a, d)
        },
        eachV: function(t) {
            var e = this;
    ...
    pq.cRenderBody = function(t, e) {
        ...
        init: function(t) {
            ...
            a && (r.dims = i.dims, r.autoFit = u.autoFit, r.pauseTO = u.timeout, n = i.pdata || [], e = n.findIndex(function(t) {
                ...
                return !0
            }), r.autoRow = c.autoRow, r.initRowHtArrSuper(), c.stripeRows && r.initStripeArr()), r.refreshColumnWidths(), r.numColWd = s.numColWd = d.numColWd = h.show ? h.width : 0, r.initColWdArrSuper(), d.init(t), t.header ? s.init(t) : r.setPanes(), d.initPost(t), t.header && s.initPost(t), r.$cright[0].scrollTop > r.getTop(r.rows) || (a ? r.refreshAllCells({
                source: l
