...
! function (t) {
    ...
    function (t) {
        ...
        }, a._removeEditOutline = function (e) {
            function n(t) {
    ...
    function (t) {
        ...
        t(document).on("pqGrid:bootup", function (t, e) {
            ...
            drop: function (t, e) {
                var n = e.helper.data("Drag"),
                    ...
                    d = function (t) {
                        var e;
                        a && (t.isFolder(a) ? (e = a, l || (c = 0)) : (e = t.getParent(a), c = t.getChildren(e).indexOf(a) + (l ? 0 : 1)), h ? t.moveNodes(f, e, c) : t.addNodes(f, e, c))
                    };
                if (n) {
                    var c, u = n.getUI(),
                        h = n.grid() == r,
        ...
        i.prototype = {
            ...
            isOver: function () { },
            newF: function () {
                return t("<svg class='pq-border-0' style='box-sizing:border-box;position:absolute;border-width:3px;border-style:solid;pointer-events:none;height:0;'></svg>").appendTo(document.body)
            },
            onCreate: function () {
                var e = this;
            ...
            onDrag: function (t, e) {
                ...
                (i.length || n.that.$cont[0].contains(r[0])) && (n.addUI(e, t, i), a())
            },
    ...
    function (t) {
        ...
        n.prototype = {
            ...
            importS: function (t, n, r, i, o) {
                ...
                for (null != o && (A = o + 1, u = D[o], D = D.slice(A), R -= A, R = R > 0 ? R : 0), T = 0, M = D.length; M > T; T++) a = D[T], l = a.indx || T, s = {}, h = s[k] = {}, f = s[S] = {}, p = s[E] = {}, g = s.pq_rowstyle = {}, v = s.pq_rowprop = {}, b.copyStyle(a, v, g), l != T && b.fillRows(I, l, !0), a.cells.forEach(function (t, e) {
                ...
                t.name && _.option("title", t.name), n && b.fillRows(I, I.length + n, !0), _.option("dataModel.data", I), q += r || 0, !i && q && _.refreshCM(b.generateCols(q, t.columns, u)), _.option("mergeCells", (C || []).map(function (t) {
        ...
        t.extend(n, {
            ...
            valueArr: function (t, e, n, r) {
                ...
                for (n = null == n ? t : n, r = null == r ? e : r, t = 0 > t ? 0 : t, e = 0 > e ? 0 : e, n = n >= w ? w - 1 : n, r = r >= f ? f - 1 : r, i = t; n >= i; i++) {
                    for (a = m[i], o = e; r >= o; o++) l = h[o].dataIndx, (s = this.getFnW(a, l)) ? d = this.execIfDirty(s) : (d = a[l], null == d ? d = "" : (c = 1 * d, d = d == c ? c : d)), p.push(d), v.push(d);
                    g.push(v), v = []
                }
        ...
        t(document).on("pqGrid:bootup", function (t, n) {
            ...
            fixWidth: function (t) {
                var e = this,
                    ...
                    u = 0,
                    h = 0;
                "right" == c && (u = s, h = d), "left" == c && (u = s), "tr" == c && (h = d);
                var f = t.$editor,
                    p = f[0].type,
                    g = "textarea" == p,
                    v = f.closest(".pq-editor-outer"),
                    m = r.offset(),
                    w = n.options.rtl,
                    x = w ? "right" : "left",
                    y = m.left,
                ...
                if (E[x] = k, v.css(E), g) {
                    F.minHeight = A;
                    var O = r.children("div"),
                        V = r.css("background-color");
                    F.fontSize = r.css("font-size"), F.fontFamily = r.css("font-family"),  F.color = r.css("color"), F.padding = parseInt(O.css("padding-top")) + 2 + "px " + (parseInt(O.css("padding-right")) + 2) + "px"
                } else F.width = o + 1;
                f.css(F), g && f.pqtext()
            }
        }
    ...
    function (t) {
        ...
        t.fn.pqtext = function () {
            function n() {
                var t = i.style,
                    e = t.minWidth;
                t.whiteSpace = "pre", t.wordWrap = "normal", t.height = 0, t.width = 0, t.minWidth = 0, t.width = i.scrollWidth + a + "px", t.minWidth = e, t.whiteSpace = "pre-wrap", t.wordWrap = "break-word", t.height = i.scrollHeight + "px"
            }
            var r = this,
                i = r[0],
                o = "pq-text",
                a = e() ? parseInt(r.css("paddingRight")) + 5 : 1;
            r.hasClass(o) || (n(), r.addClass(o).attr("spellcheck", !1).on("input", n).on("keydown", function (e) {
                var n, o, a, l = "selectionStart",
                    s = "selectionEnd";
                e.keyCode == t.ui.keyCode.ENTER && (e.altKey && (a = i.value, n = i[l], o = i[s], i.value = a.slice(0, n) + "\n" + a.slice(n, a.length), i[l] = n + 1, i[s] = o + 1, r.trigger("input")), e.preventDefault())
            }))
        }
    }(jQuery),
    function (t) {
