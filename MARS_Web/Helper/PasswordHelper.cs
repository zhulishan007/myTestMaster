...
namespace MARS_Web.Helper
{
    public class PasswordHelper
    {
        ...
        public static string EncodeMethod(string Password, string cnst_key)
        {
            byte[] bytes = ASCIIEncoding.ASCII.GetBytes(cnst_key);
        ...
        public static string DecodeMethod(string Password, string cnst_key)
        {
            byte[] bytes = ASCIIEncoding.ASCII.GetBytes(cnst_key);
            if (String.IsNullOrEmpty(Password))
            {
