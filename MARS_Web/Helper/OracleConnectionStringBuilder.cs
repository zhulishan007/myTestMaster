...
namespace MARS_Web.Helper
{
    public class OracleConnectionStringBuilder
    {
        ...
        {
            string connectionString =  String.Format("Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST={0})(PORT={1}))(CONNECT_DATA=(SERVER=DEDICACATED)(SERVICE_NAME={2})));User Id={3};Password={4};Min Pool Size=10;Connection Lifetime=600;Connection Timeout=300;Incr Pool Size=5; Decr Pool Size=2;Max Pool Size=30",
